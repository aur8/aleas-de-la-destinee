...
void Player::generate_hp() {
    double constitution_percentage = m_con / 20.0; // Convertir la constitution en pourcentage

    int max_hp = generate_binomial(20, constitution_percentage); // Lancer 20 dés pipés selon la constitution
